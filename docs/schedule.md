...
| Who | Role | When | Where |
| --- | --- | --- | --- |
| Amr Talaat Abdel Hamid | Instructor | <span class="pill pending">pending</span> | <span class="pill pending">pending</span> |
| Hassan Al Moalim | Teaching Assistant | <span class="pill pending">pending</span> | <span class="pill pending">pending</span> |

Office hours are not listed in the official syllabus and are still being
arranged. Until they are announced, catch a TA during the lab session or email
the teaching team.
